...
_QA_PROMPT = (
    ...
    "BASELINE (a valid request → 2xx) so you know what success looks like, THEN run negative "
    "cases. You are FUNCTIONAL testing — send ONE request per case; NEVER loop-fire an "
    "endpoint to generate load or hammer a server (that is a load-testing tool's job, not "
    "yours). You do NOT "
