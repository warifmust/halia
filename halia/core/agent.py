...
SYSTEM_PROMPT = (
    ...
    "4) ASK the user — specifically what parts they want you to learn and follow. Don't "
    "assume — let them choose (e.g. 'learn the table format', 'learn the API schema', 'all of it'). "
